...
(
    ...
    lecturer_academic_degree integer     not null,
    lecturer_academic_title  integer     not null,
    lecturer_deleted         boolean     not null,
    lecturer_rank            varchar(30) not null,
