...
(
    ...
    CONSTRAINT orders_max_count_unique UNIQUE (max_count_faculty, max_count_department, max_count_year)
);
...
(
    ...
    token_keep_until timestamp not null check ( token_keep_until > now() )
);
